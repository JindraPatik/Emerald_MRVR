    ...
    const UInputAction* PalmGrabAction)
{
  ...
  if (IsValid(PinchGrabAction))
  {
    EnhancedInputComponent->BindAction(
        PinchGrabAction, ETriggerEvent::Started, Grabber.Get(), &UIsdkGrabberComponent::PinchGrab);
    EnhancedInputComponent->BindAction(
        PinchGrabAction,
        ETriggerEvent::Completed,
        Grabber.Get(),
        &UIsdkGrabberComponent::PinchRelease);
    EnhancedInputComponent->BindAction(
        PinchGrabAction,
  ...
  {
    EnhancedInputComponent->BindAction(
        PalmGrabAction, ETriggerEvent::Started, Grabber.Get(), &UIsdkGrabberComponent::PalmGrab);
    EnhancedInputComponent->BindAction(
        PalmGrabAction,
        ETriggerEvent::Completed,
        Grabber.Get(),
        &UIsdkGrabberComponent::PalmRelease);
    EnhancedInputComponent->BindAction(
        PalmGrabAction,
        ETriggerEvent::Canceled,
        Grabber.Get(),
    ...
    const FName& InThumbTipSocketName)
{
  ...
  if (ensure(PinchGrabRecognizer))
  {
    ...
    PinchGrabRecognizer->PinchGrabStarted.AddUniqueDynamic(
        this, &UIsdkGrabInteractionRigComponent::HandlePinchGrabStartedInput);
    PinchGrabRecognizer->PinchGrabFinished.AddUniqueDynamic(
        this, &UIsdkGrabInteractionRigComponent::HandlePinchGrabFinishedInput);
  }
  ...
  if (ensure(PalmGrabRecognizer))
  {
    ...
    PalmGrabRecognizer->PalmGrabStarted.AddUniqueDynamic(
        this, &UIsdkGrabInteractionRigComponent::HandlePalmGrabStartedInput);
    PalmGrabRecognizer->PalmGrabFinished.AddUniqueDynamic(
        this, &UIsdkGrabInteractionRigComponent::HandlePalmGrabFinishedInput);
  }
...
void UIsdkGrabInteractionRigComponent::HandlePinchGrabStartedInput()
{
  if (!Grabber)
  {
    return;
...
void UIsdkGrabInteractionRigComponent::HandlePinchGrabFinishedInput()
{
  if (!Grabber)
  {
    return;
...
void UIsdkGrabInteractionRigComponent::HandlePalmGrabStartedInput()
{
  if (!Grabber)
  {
    return;
...
void UIsdkGrabInteractionRigComponent::HandlePalmGrabFinishedInput()
{
  if (!Grabber)
  {
    return;
